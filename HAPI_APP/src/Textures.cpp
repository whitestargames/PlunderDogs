...
std::shared_ptr<Sprite> Textures::m_battleIcons;
std::shared_ptr<Sprite> Textures::m_pauseButton;
std::shared_ptr<Sprite> Textures::m_chickenButton;
std::shared_ptr<Sprite> Textures::m_pauseMenuBackground;
std::shared_ptr<Sprite> Textures::m_resumeButton;
std::shared_ptr<Sprite> Textures::m_quitButton;
std::shared_ptr<Sprite> Textures::m_CompassBackGround;
std::shared_ptr<Sprite> Textures::m_CompassPointer;
std::shared_ptr<Sprite> Textures::m_activeFactionToken;
std::shared_ptr<Sprite> Textures::m_postBattleBackground;
std::shared_ptr<Sprite> Textures::m_doneButton;
